...
const QUICK_ACTIONS = [
        { id: '1', title: 'Skin AI Analysis', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'Beauty Recommender', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'AR Try-On', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Style Assistant', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Treatment Planner', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'beauty & wellness');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>AI beauty intelligence & personalization</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — beauty & wellness</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask AI Aesthetics AI anything...`}
