...
// AI Aesthetics | AI beauty intelligence and personalization
...
const ACTIONS = [
  { id: '1', title: 'Skin AI Analysis', icon: 'sparkles-outline' },
  { id: '2', title: 'Beauty Recommender', icon: 'sparkles-outline' },
  { id: '3', title: 'AR Try-On', icon: 'sparkles-outline' },
  { id: '4', title: 'Style Assistant', icon: 'sparkles-outline' },
  { id: '5', title: 'Treatment Planner', icon: 'sparkles-outline' },
];
...
export default function HomeScreen() {
  ...
  async function askAI() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'beauty and wellness');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>AI beauty intelligence and personalization</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — beauty and wellness</Text>
        </View>
        <TextInput
