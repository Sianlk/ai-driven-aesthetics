...
// AI Aesthetics — AI Agents & Workforce
...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('Skin AI Analysis');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: beauty & wellness</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['Skin AI Analysis','Beauty Recommender','AR Try-On','Style Assistant','Treatment Planner'].map((f) => (
            <TouchableOpacity
              key={f}
