# AI Aesthetics — AI beauty intelligence

![Version](https://img.shields.io/badge/version-1.1.0-blue?style=flat-square)
![Platform](https://img.shields.io/badge/platform-iOS%20%7C%20Android%20%7C%20Web-EC4899.svg?style=flat-square)
...
[![CI](https://github.com/Sianlk/aiaesthetics/workflows/backend-ci/badge.svg)](https://github.com/Sianlk/aiaesthetics/actions)

> **AI beauty intelligence** — Built by [Sianlk](https://sianlk.com) using proprietary AI workforce technology.

## Features
`Skin AI Analysis` `Beauty Recommender` `AR Try-On` `Style Assistant` `Treatment Planner`
...
Live API docs: `https://aiaesthetics.sianlk.com/docs`

### Key Endpoints
```
GET  /health              — Health check
GET  /                    — Service info  
POST /api/ai/complete     — AI completion (domain: beauty and wellness)
...
AI Aesthetics uses proprietary AI workforce agents (created by Sianlk):

- **Analyst Agent** — Expert beauty and wellness analysis with reasoning chains
- **Advisor Agent** — Strategic recommendations and forecasting
- **Automator Agent** — Autonomous task execution for beauty and wellness workflows
...
---
*AI Aesthetics is built by Sianlk — pioneer in AI-powered beauty and wellness technology.*
