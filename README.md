...
<img src="assets/graphics/icon-1024.svg" width="120" alt="AI Aesthetics Icon" />

# AI Aesthetics

### Beauty Redefined by Intelligence

[![CI](https://github.com/Sianlk/ai-driven-aesthetics/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/ai-driven-aesthetics/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/ai-driven-aesthetics/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/ai-driven-aesthetics/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://aiaesthetics.app)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**beauty, AI, style, health**

[Website](https://aiaesthetics.app) · [Privacy Policy](https://aiaesthetics.app/privacy) · [Support](https://aiaesthetics.app/support)
...
**AI Aesthetics** — Beauty Redefined by Intelligence
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to beauty
...
```bash
# Clone the repo
git clone https://github.com/Sianlk/ai-driven-aesthetics.git
cd ai-driven-aesthetics
