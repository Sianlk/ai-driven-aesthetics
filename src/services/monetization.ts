// Monetization & Subscription Engine — AI Aesthetics
...
export const PLANS: Record<Plan, PlanConfig> = {
  free: {
    ...
    features: [
      '10 AI requests/day',
      'Basic beauty and wellness features',
      'Community support',
    ],
  ...
  starter: {
    ...
    price_monthly: 9.99,
    price_annual: 7.99,
    sku_monthly: 'com.sianlk.aiaesthetics.starter.monthly',
    sku_annual: 'com.sianlk.aiaesthetics.starter.annual',
    features: [
      '100 AI requests/day',
      'All beauty and wellness features',
  ...
  pro: {
    ...
    price_monthly: 29.99,
    price_annual: 19.99,
    sku_monthly: 'com.sianlk.aiaesthetics.pro.monthly',
    sku_annual: 'com.sianlk.aiaesthetics.pro.annual',
    features: [
  ...
  enterprise: {
    ...
    price_monthly: 99.99,
    price_annual: 79.99,
    sku_monthly: 'com.sianlk.aiaesthetics.enterprise.monthly',
    sku_annual: 'com.sianlk.aiaesthetics.enterprise.annual',
    features: [
