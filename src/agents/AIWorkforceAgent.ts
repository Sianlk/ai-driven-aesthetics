// AI Workforce Agent — AI Aesthetics
// Autonomous AI worker for beauty & wellness
...
// Specialised AI agents for beauty & wellness
const AGENT_PERSONAS = {
  analyst: {
    name: 'AI Aesthetics Analyst',
    role: `Expert beauty & wellness analyst with deep knowledge of skin analysis, beauty recommendations, AR try-on, style AI.`,
    capabilities: ["Skin AI Analysis", "Beauty Recommender", "AR Try-On", "Style Assistant", "Treatment Planner"],
  },
  advisor: {
    name: 'AI Aesthetics Advisor',
    role: `Senior beauty & wellness advisor providing strategic recommendations.`,
    capabilities: ['Strategic planning', 'Risk assessment', 'Optimization'],
  },
  automator: {
    name: 'AI Aesthetics Automator',
    role: `Autonomous beauty & wellness task executor and workflow manager.`,
