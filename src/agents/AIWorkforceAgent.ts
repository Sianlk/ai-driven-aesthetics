...
// Autonomous AI worker for beauty and wellness
...
const PERSONAS = {
  analyst: {
    ...
    role: `Expert beauty and wellness analyst. Capabilities: skin analysis, beauty recommendations, AR try-on, style AI.`,
  },
  advisor: {
    name: 'AI Aesthetics Advisor',
    role: `Senior beauty and wellness advisor providing strategic recommendations.`,
  },
  automator: {
    name: 'AI Aesthetics Automator',
    role: `Autonomous beauty and wellness task executor and workflow manager.`,
  },
};
