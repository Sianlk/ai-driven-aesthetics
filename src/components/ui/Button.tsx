// Button Component — AI Aesthetics
...
const s = StyleSheet.create({
  ...
  v_primary:   { backgroundColor: '#EC4899' },
  v_secondary: { backgroundColor: '#F472B633' },
  v_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#EC4899' },
  v_ghost:     { backgroundColor: 'transparent' },
  v_danger:    { backgroundColor: '#EF4444' },
  v_ai:        { backgroundColor: '#DB2777', borderWidth: 1, borderColor: '#F472B6' },
  lbl:    { fontSize: 14, fontWeight: '600' },
  lv_primary:   { color: '#FFFFFF' },
  lv_secondary: { color: '#DB2777' },
  lv_outline:   { color: '#EC4899' },
  lv_ghost:     { color: '#EC4899' },
