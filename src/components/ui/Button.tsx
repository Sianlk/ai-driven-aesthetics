...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#EC4899' },
  variant_secondary: { backgroundColor: '#F472B633' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#EC4899' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#DB2777', borderWidth: 1, borderColor: '#F472B6' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#DB2777' },
  label_outline:   { color: '#EC4899' },
  label_ghost:     { color: '#EC4899' },
