...
const SLIDES = [{"emoji": "\ud83d\ude80", "title": "AI Aesthetics", "body": "Beauty Redefined by Intelligence"}, {"emoji": "\ud83d\udd12", "title": "Bank-Grade Security", "body": "Your data is protected with end-to-end encryption and MFA."}, {"emoji": "\u26a1", "title": "Built for Speed", "body": "Real-time AI processing with sub-second response times."}];
